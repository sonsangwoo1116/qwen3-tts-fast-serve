...
Requires: pyzmq (with asyncio), msgpack, qwen3_tts_engine, qwen_tts (tokenizer), soundfile.
"""
...
# Add parent so we can import qwen3_tts_engine
...
async def main():
    ...
    from qwen3_tts_engine.zmq import ZMQOutputBridge
    import warnings
