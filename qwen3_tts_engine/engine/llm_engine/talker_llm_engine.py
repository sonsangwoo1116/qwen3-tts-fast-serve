...
from qwen3_tts_engine.engine.model_runner.talker_mode_runner import TalkerModeModelRunner
    ...
    def postprocess(self, seqs: list[Sequence], token_ids: list[int], hidden_states: list[torch.Tensor]):
        ...
        for seq, token_id in zip(seqs, token_ids):
            ...
            if seq.request_id is not None:
                ...
                # Force finish if sequence reaches max model length to prevent
                # CUDA graph block_tables overflow (max_num_blocks is fixed).
